...
pub enum RootViewportMode {
    ...
    /// Run the root viewport as a logical controller with no native presentation window.
    ///
    ...
    ///
    /// On Windows, Glow retains a private hidden window for the lifetime of its GL configuration.
    /// This resource window is never shown, exposed as the root window, or used for repainting.
    Windowless,
}
